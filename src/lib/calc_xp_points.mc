...
function main {
    ...
    execute if score #current_levels onyx.xp_points matches ..16 run function lib:calc_xp_points/below16
    execute if score #current_levels onyx.xp_points matches 17..31 run function lib:calc_xp_points/17to31
    execute if score #current_levels onyx.xp_points matches 32.. run function lib:calc_xp_points/above32
